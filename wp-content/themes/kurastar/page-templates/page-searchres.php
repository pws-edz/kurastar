...
get_header(); ?>
<?php
$menu_slug = my_get_menu_item_slug();  
...
<div class="defaultWidth center clear-auto bodycontent bodycontent-index result-page ">
    ...
    <!-- Nav tabs -->
            ...
            <?php 
            $post_count = count_posts($menu_slug);
            // $published_posts = $count_posts->publish;
            // echo $published_posts;
           
            ?>
            フィリピン, グルメ result (<?php echo $post_count; ?> items):
            </span>
            ...
            // Start the Loop.
              ...
              $postid = get_wpposts($_POST['country'], $_POST['category']);
